...
const EditKeyAreas = ({ handleModalClose, getAllList, editData }) => {
  ...
  const handleBrandSubmit = async data => {
    try {
      ...
      // Submit to API
      const response = await BudgetScopeService.UpdateKeyAreasById(id, formData)
