...
const EditUnit = ({handleModalClose,getAllList,editData}) => {
  ...
  const handleUnitSubmit = async data => {
    ...
    try {
      ...
      // Submit to API
      const response = await ItemSettingsServices.updateUnitsById(
        id,
        formData
      )
  ...
  return (
    <>
 <FormProvider {...form}>
        <form onSubmit={form.handleSubmit(handleUnitSubmit)}>
