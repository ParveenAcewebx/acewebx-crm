...
const FormInputFileUploaderSingleCSV = ({
  name,
  control,
  label,
  errors,
  ...
  const renderDropzone = useCallback(
    field => {
      ...
      const { getRootProps, getInputProps } = useDropzone({
        ...
        onDrop,
        onDropRejected: () => {
          console.error('Only CSV file allowed. Max size 15 MB.')
        }
      })
...
export default FormInputFileUploaderSingleCSV
