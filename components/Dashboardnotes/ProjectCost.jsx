...
const ProjectCost = ({ editId, editData }) => {
  const ProjectCostData = editData?.leadProject?.budget_totals
    ...
    <>
      <CardHeader className='theme-bg-light-rgba min-h-14 !p-0'>
        <CardTitle className='border-color-grey flex justify-between gap-4 border-b p-3'>
          <div className='!text-lg'>Project Cost SQFT </div>
