...
const ProjectPrice = ({ editId, editData }) => {
  const ProjectPriceData = editData?.leadProject?.budget_totals
    ...
    <>
      <CardHeader className='theme-bg-light-rgba min-h-14 !p-0'>
        <CardTitle className='border-color-grey flex justify-between gap-4 border-b p-3'>
          <div className='!text-lg'>Project Price/SQFT </div>
      ...
      <div className='h-96 overflow-auto p-0'>
        {/* {ProjectCostData?.map((item, index) => ( */}
        <div>
